...
#ifndef DREAMWEAVERIPHONEAI_WATCH_APP_SWIFT_H
#define DREAMWEAVERIPHONEAI_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DreamWeaverIphoneAI_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC29DreamWeaverIphoneAI_Watch_App14WorkoutManager")
...
@class NSDate;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaverIphoneAI_Watch_App)) <HKWorkoutSessionDelegate>
...
@class WCSession;
@class NSString;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaverIphoneAI_Watch_App)) <WCSessionDelegate>
...
@class HKSampleType;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaverIphoneAI_Watch_App)) <HKLiveWorkoutBuilderDelegate>
