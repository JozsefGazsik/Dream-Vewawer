...
#ifndef DREAM_VEWAWER_SWIFT_H
#define DREAM_VEWAWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Dream_Vewawer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC13Dream_Vewawer24WatchConnectivityManager")
...
@class WCSession;
@interface WatchConnectivityManager (SWIFT_EXTENSION(Dream_Vewawer))
- (void)sessionWatchStateDidChange:(WCSession * _Nonnull)session;
@end

@class NSString;
@interface WatchConnectivityManager (SWIFT_EXTENSION(Dream_Vewawer)) <WCSessionDelegate>
