...
#ifndef DREAMWEAVERWATCH_SWIFT_H
#define DREAMWEAVERWATCH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DreamWeaverWatch",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC16DreamWeaverWatch14WorkoutManager")
...
@class NSDate;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaverWatch)) <HKWorkoutSessionDelegate>
...
@class WCSession;
@class NSString;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaverWatch)) <WCSessionDelegate>
...
@class HKSampleType;
@interface WorkoutManager (SWIFT_EXTENSION(DreamWeaverWatch)) <HKLiveWorkoutBuilderDelegate>
